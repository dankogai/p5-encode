...
#
package Encode::GSM0338::Charset::Turkish;
...
use constant LATIN_CAPITAL_LETTER_G_WITH_BREVE           => "\x{011E}";
use constant LATIN_CAPITAL_LETTER_I_WITH_DOT_ABOVE       => "\x{0130}";
use constant LATIN_CAPITAL_LETTER_S_WITH_CEDILLA         => "\x{015E}";
use constant LATIN_SMALL_LETTER_DOTLESS_I                => "\x{0131}";
use constant LATIN_SMALL_LETTER_G_WITH_BREVE             => "\x{011F}";
use constant LATIN_SMALL_LETTER_S_WITH_CEDILLA           => "\x{015F}";
...
sub GSM2UNI_BASIC_SET {
	+{
		...
		"\x0B" => __PACKAGE__->LATIN_CAPITAL_LETTER_G_WITH_BREVE,
		"\x0C" => __PACKAGE__->LATIN_SMALL_LETTER_G_WITH_BREVE,
		...
		"\x1C" => __PACKAGE__->LATIN_CAPITAL_LETTER_S_WITH_CEDILLA,
		"\x1D" => __PACKAGE__->LATIN_SMALL_LETTER_S_WITH_CEDILLA,
		...
		"\x40" => __PACKAGE__->LATIN_CAPITAL_LETTER_I_WITH_DOT_ABOVE,
		...
		"\x60" => __PACKAGE__->LATIN_SMALL_LETTER_C_WITH_CEDILLA,
...
sub GSM2UNI_SHIFT_SET {
	+{
		...
		"\x1B\x47" => __PACKAGE__->LATIN_CAPITAL_LETTER_G_WITH_BREVE,
		"\x1B\x49" => __PACKAGE__->LATIN_CAPITAL_LETTER_I_WITH_DOT_ABOVE,
		"\x1B\x53" => __PACKAGE__->LATIN_CAPITAL_LETTER_S_WITH_CEDILLA,
		"\x1B\x65" => __PACKAGE__->EURO_SIGN,
		"\x1B\x67" => __PACKAGE__->LATIN_SMALL_LETTER_G_WITH_BREVE,
		"\x1B\x69" => __PACKAGE__->LATIN_SMALL_LETTER_DOTLESS_I,
		"\x1B\x73" => __PACKAGE__->LATIN_SMALL_LETTER_S_WITH_CEDILLA,
	};
}
